...
def FUDS(dataset,dataset_name,net, optimizer,lr_schedule, delta, device, n_epochs=200, batch_size=2048, seed=0):
...
########Update the threshold parameter#######
    ...
    ########choose the model with best performance on validation set###########
        ...
        n11, n10, n01, n00 = number_of_sample(n11_ori, n10_ori, n01_ori, n00_ori,  tmid, n)
...
def training_FUDS(dataset_name,delta, seed):
    ...
    Result = FUDS(dataset=dataset,dataset_name=dataset_name,
                     net=net,
